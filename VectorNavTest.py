...
model = s.read_model_number()
ypr = s.read_yaw_pitch_roll()
print(model)
print(ypr)
print("Compass bearing: " + str(ypr.x))
gps = s.read_ins_state_lla()
# gps = p.from_lla()
print("Position: " + str(gps.position))
# gpsOffset = s.read_gps_antenna_offset()
# print("Antenna Offset: : " + str(gpsOffset))
# gpsCompassRead = s.read_gps_compass_estimated_baseline()
